...
function Icon({ name }: { name: IconName }) {
  ...
  if (name === 'members') {
    return (
      <svg className={className} viewBox="0 0 24 24" fill="none">
        <path d="M16 11a4 4 0 1 0-3.46-6A5.5 5.5 0 0 1 15 9.5c0 .52-.07 1.02-.21 1.5H16Zm-6.5 0a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Zm6.5 2c-1.21 0-2.33.35-3.28.94A7.02 7.02 0 0 1 16.5 20H21v-2a5 5 0 0 0-5-5Zm-6.5 0A5.5 5.5 0 0 0 4 18.5V20h11v-1.5A5.5 5.5 0 0 0 9.5 13Z" fill="currentColor" />
      </svg>
    );
  }
  ...
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none">
      <path d="M7 2a1 1 0 0 1 1 1v1h8V3a1 1 0 1 1 2 0v1h1.5A2.5 2.5 0 0 1 22 6.5v12A2.5 2.5 0 0 1 19.5 21h-15A2.5 2.5 0 0 1 2 18.5v-12A2.5 2.5 0 0 1 4.5 4H6V3a1 1 0 0 1 1-1Zm13 8H4v8.5a.5.5 0 0 0 .5.5h15a.5.5 0 0 0 .5-.5V10ZM6 13h3v3H6v-3Zm5 0h3v3h-3v-3Z" fill="currentColor" />
    </svg>
  );
}
...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex flex-col border-r border-slate-100 bg-white shadow-soft transition-all duration-300 ease-in-out md:sticky md:top-0 md:z-20 md:h-screen ${
